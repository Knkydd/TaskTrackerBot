...
public class ButtonsMaps {
    ...
    public final static Map<String, String> buildMenuButtons = new HashMap<>();
    ...
    static {
        ...
        buildMenuButtons.put(ConstantKB.UPBUILD_BUTTON, ConstantKB.CALLBACK_UPBUILD_BUTTON);
        buildMenuButtons.put(ConstantKB.UPGRADE_BUTTON, ConstantKB.CALLBACK_UPGRADE_BUTTON);
