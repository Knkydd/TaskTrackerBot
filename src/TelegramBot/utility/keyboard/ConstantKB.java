...
public class ConstantKB {
    ...
    public final static String UPGRADE_BUTTON = "Улучшить";
    public final static String UPBUILD_BUTTON = "Построить";
    ...
    public final static String CALLBACK_UPGRADE_BUTTON = "upgradeBuild";
    public final static String CALLBACK_UPBUILD_BUTTON = "upbuildBuild";

    public final static String[] listCallbackData = new String[]{CALLBACK_START_BUTTON, CALLBACK_CONTINUE_BUTTON, CALLBACK_LEADERBOARD_BUTTON, CALLBACK_ACTION_BUTTON,
            CALLBACK_BUILDS_BUTTON, CALLBACK_ATTACK_BUTTON, CALLBACK_NEXT_MOVE_BUTTON, CALLBACK_BACK_BUTTON, MAIN_MENU, CALLBACK_ARMY_BUTTON, CALLBACK_UPGRADE_BUTTON, CALLBACK_UPBUILD_BUTTON};
}
