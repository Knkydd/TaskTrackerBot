...
public class ConstantResourcesForBuilds {
    public final static Integer LIMIT_LEVEL_FOR_TOWN_HALL = 5;
    public final static Integer LIMIT_LEVEL_FOR_QUARRY = 6;
    public final static Integer LIMIT_LEVEL_FOR_SAWMILL = 4;
    public final static Integer LIMIT_LEVEL_FOR_FARM = 5;
    public final static Integer LIMIT_LEVEL_FOR_TRADE_BUILD = 5;
    public final static Integer LIMIT_LEVEL_FOR_BARRACKS = 4;
    public final static Integer LIMIT_LEVEL_FOR_MAGE_TOWER = 4;
    public final static Integer LIMIT_LEVEL_FOR_SHOOTING_RANGE = 4;
    public final static Integer LIMIT_LEVEL_FOR_CHAPEL_OF_LAST_HOPE = 4;
    public final static Integer LIMIT_LEVEL_FOR_CHURCH = 4;
    ...
    public final static Map<String, Integer> RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_2 = new HashMap<>();
    public final static Map<String, Integer> RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_3 = new HashMap<>();
    public final static Map<String, Integer> RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_4 = new HashMap<>();
    public final static Map<String, Integer> RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_5 = new HashMap<>();
    ...
    static {
        ...
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_2.put("Wood", 50);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_2.put("Gold", 500);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_2.put("Stone", 30);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_2.put("Food", 0);

        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_3.put("Wood", 100);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_3.put("Gold", 700);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_3.put("Stone", 70);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_3.put("Food", 0);

        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_4.put("Wood", 150);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_4.put("Gold", 1000);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_4.put("Stone", 120);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_4.put("Food", 0);

        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_5.put("Wood", 250);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_5.put("Gold", 1500);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_5.put("Stone", 200);
        RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_5.put("Food", 0);

        RESOURCES_FOR_TOWN_HALL_UPGRADE.put(1, RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_2);
        RESOURCES_FOR_TOWN_HALL_UPGRADE.put(2, RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_3);
        RESOURCES_FOR_TOWN_HALL_UPGRADE.put(3, RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_4);
        RESOURCES_FOR_TOWN_HALL_UPGRADE.put(4, RESOURCES_FOR_TOWN_HALL_UPGRADE_TO_5);
